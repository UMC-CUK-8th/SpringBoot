...
public enum ErrorStatus implements BaseErrorCode {
    ...
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND,"PREFER4001", "음식 카테고리가 없습니다."),
    STATUSES_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND,"STATUSES4001","해당 상태카테고리가 없습니다."),
    // For test
    TEMP_EXCEPTION(HttpStatus.BAD_REQUEST, "TEMP4001", "이거는 테스트"),
    STORE_NOT_FOUND(HttpStatus.NOT_FOUND,"STORE4001", "해당 음식점이 없습니다."),
