...
public class StoreInfoRestController {
    ...
    public ApiResponse<StoreInfoResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistStores @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
    ...
    public ApiResponse<StoreInfoResponseDTO.MissionPreViewListDTO> getMissionList(@ExistStores @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
