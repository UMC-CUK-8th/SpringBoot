...
public class StoreInfoRestController {
    ...
    public ApiResponse<StoreInfoResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistStores @PathVariable(name = "storeId") Long storeId, @ZeroBasedPage Integer page){
        Page<Review> reviewList = storeQueryService.getReviewList(storeId,page);
        return ApiResponse.onSuccess(StoreInfoConverter.reviewPreViewListDTO(reviewList));
    ...
    public ApiResponse<StoreInfoResponseDTO.MissionPreViewListDTO> getMissionList(@ExistStores @PathVariable(name = "storeId") Long storeId,
                                                                                  @ZeroBasedPage Integer page){
        Page<Mission> missionList = storeQueryService.getMissionList(storeId,page);
        return ApiResponse.onSuccess(StoreInfoConverter.MissionPreViewListDTO(missionList));
    }
}