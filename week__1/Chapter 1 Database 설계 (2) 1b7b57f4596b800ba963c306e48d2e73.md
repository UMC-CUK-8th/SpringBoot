...
- ER 다이어그램
    ...
    예를 들어, 쇼핑몰에서 DB 테이블에 회원의 이름, id, 주문 상품 정보를 저장한다면 회원이 개체가 되고, 이름, id, 주문 상품은 속성이 됩니다. 속성은 DB 테이블에서 열로 표현합니다.
...
[시니어 미션](https://www.notion.so/1b7b57f4596b81b99e5ac90a4a9155bc?pvs=21)
