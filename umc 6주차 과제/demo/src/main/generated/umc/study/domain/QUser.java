...
public class QUser extends EntityPathBase<User> {
    ...
    public final ListPath<PersonalPreference, QPersonalPreference> personalPreferenceList = this.<PersonalPreference, QPersonalPreference>createList("personalPreferenceList", PersonalPreference.class, QPersonalPreference.class, PathInits.DIRECT2);
